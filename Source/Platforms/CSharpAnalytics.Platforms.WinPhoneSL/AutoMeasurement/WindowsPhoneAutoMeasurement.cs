...
using CSharpAnalytics.Platforms.WinPhoneSL.SystemInfo;
...
namespace CSharpAnalytics.Platforms.WinPhoneSL
{
    /// <summary>
    ...
    public class WindowsPhoneAutoMeasurement : BaseAutoMeasurement
    {
        ...
        {
            var webRequester = new HttpClientRequester(ClientUserAgent + " " + WindowsPhoneSystemInfo.GetSystemUserAgent());
