...
namespace CSharpAnalytics.Test.Protocols.Measurement
{
    ...
    public class MeasurementConfigurationTests
    {
        ...
        {
            var configuration = new MeasurementConfiguration("UA-1234-5", "ApplicationName", "1.2.3.4", false, false);
        ...
        {
            Assert.ThrowsException<ArgumentException>(() => new MeasurementConfiguration("NO-1234-5", "ApplicationName", "1.2.3.4", false, false));
        }

        [TestMethod]
        public void MeasurementConfiguration_Constructor_Throws_ArgumentException_If_AccountID_Does_Not_Have_Two_Numeric_Parts()
        {
            Assert.ThrowsException<ArgumentException>(() => new MeasurementConfiguration("UA-1234", "ApplicationName", "1.2.3.4", false, false));
        }
        ...
        {
            new MeasurementConfiguration("NO-1234-5", "ApplicationName", "1.2.3.4", false, false);
        }
        ...
        public void MeasurementConfiguration_Constructor_Throws_ArgumentException_If_AccountID_Does_Not_Have_Two_Numeric_Parts()
        {
            new MeasurementConfiguration("UA-1234", "ApplicationName", "1.2.3.4", false, false);
        }
        ...
        public void MeasurementConfiguration_SampleRate_Property_Throws_ArgumentOutOfRangeException_If_Below_0()
        {
            new MeasurementConfiguration("UA-1234-5", "ApplicationName", "1.2.3.4", false, false) { SampleRate = -0.01 };
        }
        ...
        public void MeasurementConfiguration_SampleRate_Property_Throws_ArgumentOutOfRangeException_If_Above_100()
        {
            new MeasurementConfiguration("UA-1234-5", "ApplicationName", "1.2.3.4", false, false) { SampleRate = 100.01 };
        }
#endif
    }
}